...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full font-sans px-2 sm:px-4 md:px-10 overflow-hidden"
      ref={containerRef}
    >
      <div ref={ref} className="relative max-w-7xl mx-auto pb-12 sm:pb-20 overflow-hidden">
        {data.map((item, index) => (
          <div
            key={index}
          ...
          >
            ...
            <div className="relative pl-12 sm:pl-20 pr-2 sm:pr-4 md:pl-4 w-full min-w-0">
        ...
        <div
          ...
          className="absolute left-4 sm:left-8 md:left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-700 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] pointer-events-none"
        >
          <motion.div
            style={{
