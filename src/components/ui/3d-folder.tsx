    ...
    <>
      ...
      >
        ...
        <div className="relative flex items-center justify-center mb-4" style={{ height: "160px", width: "200px" }}>
          ...
          <div
            className="absolute w-32 h-24 bg-[var(--folder-back)] rounded-lg shadow-md"
            style={{
          ...
          <div
            className="absolute w-12 h-4 bg-[var(--folder-tab)] rounded-t-md"
            style={{
          ...
          <div
            className="absolute w-32 h-24 bg-[var(--folder-front)] rounded-lg shadow-lg"
            style={{
        ...
        {/* Hover hint */}
        <div
          className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-1.5 text-xs text-white/50 transition-all duration-300"
          style={{
...
export function ImageLightbox({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn("relative overflow-hidden", "rounded-2xl", "bg-card/50 backdrop-blur-md", "border border-white/10", "shadow-2xl")}
          style={{
        ...
        >
            ...
            >
              {projects.map((project, idx) => (
                <img
                  ...
                  alt={project.title}
                  className="w-full h-auto max-h-[70vh] object-contain bg-black/40 flex-shrink-0"
                  style={{ minWidth: "100%" }}
                />
              ))}
            </div>
          ...
          <div
            className={cn("px-6 py-5", "bg-card/50 backdrop-blur-xl", "border-t border-white/10")}
            style={{
              opacity: animationPhase === "complete" && !isClosing ? 1 : 0,
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1">
                  <p className="text-sm text-white/50">
                    <kbd className="px-1.5 py-0.5 mx-0.5 text-xs font-medium bg-black/50 text-white/50 rounded border border-white/10">
                      ←
                    </kbd>
                    <kbd className="px-1.5 py-0.5 mx-0.5 text-xs font-medium bg-black/50 text-white/50 rounded border border-white/10">
                      →
